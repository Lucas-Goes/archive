...
export function Vision1Theme({
  ...
  return (
    ...
    >
      {/* BACKGROUND IMAGE */}
      <img
        src="https://archive-me.com/themes/vision1/v1-bg.jpg"
        alt=""
        className="absolute inset-0 w-full h-full object-cover scale-160 translate-x-[-90px] translate-y-[100px]"
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(0, 0, 0, 0.3) 20%, rgba(17, 16, 16, 0.2) 90%, rgba(5, 5, 5, 0.05) 100%)",
        }}
      />
